...
public class UcAntMinerPB extends Classifier {
     ...
     *
     */
    public void generateModel(String toolName, String[] args){
    	try{    		
    		constructModel(toolName, args);    		
    		
    	}catch(Exception e){
    		Logger.log("Model Generation failed.", e.getMessage());
    	}    	
     ...
     *
     */
    public void classifyData(String[] args, Model model){    	
    	try{
    		super.classifyData(args, model);
    	}catch(Exception e){
